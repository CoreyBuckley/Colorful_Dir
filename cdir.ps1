...
#>
    ...
    Process {  
        dir -r $path | ForEach-Object {                
            $formatPattern = "{0,-5}`t{1,25}`t{2,10} {3,-25}"; #Mode, LastWriteTime, Length, and Name will be used for the string interpolation
        ...
        if ($initial -eq 0) {  
            ...
            Write-Host -BackgroundColor "black" -ForegroundColor "white" "`n`tDirectory:" $dirPath;
